...
const Config = new function() {
     ...
     */
    this.coinName = 'traaittPlatform';

    /**
     * Prefix for URI encoded addresses
     */
    this.uriPrefix = 'traaittplatform://';
     ...
     */
    this.devFeeAddress = 'TRsPQabk6RyXMY4vEqmv9QY67Bk5yog31Jh6A4hwR754eubwCmfxgdLC9XyjD6tmJG8YS4iSz4JPrZnorZ8hwT5j24ah3nNKa';
     ...
     */
    this.defaultDaemon = new Daemon('europenodetwo.traaittplatform.com', 23896);
     ...
     *
     */
    this.repoLink = 'https://github.com/turtlecoin/traaittplatform-mobile-wallet/issues';

    /**
     * This only controls the name in the settings screen.
     */
    this.appName = 'traaittPlatform Mobile';
     ...
     */
    this.explorerBaseURL = 'https://explorer.traaittplatform.com/?search=';
     ...
     */
    this.nodeListURL = 'https://raw.githubusercontent.com/traaittplatform/traaittplatform-nodes/master/traaittplatform-nodes.json';
};
